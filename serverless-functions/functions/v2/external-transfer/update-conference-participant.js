...
const logger = new Logger(
  '/functions/v2/external-transfer/update-conference-participant.js',
);
...
exports.handler = async function (context, event, callback) {
  try {
    ...
    if (validationError) {
      logger.error(
        'external-transfer/update-conference-participant | handler',
    ...
    logger.error(
      'external-transfer/update-conference-participant',
